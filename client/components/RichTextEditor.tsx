    ...
    <div className="border border-gray-200 rounded-lg focus-within:ring-2 focus-within:ring-gray-500 focus-within:border-gray-500 bg-white">
      ...
      <div className="flex">
        ...
        <div className={`${showPreview ? "w-1/2 border-r border-gray-200" : "w-full"}`}>
          <textarea
            ...
            className="w-full p-3 resize-none min-h-[200px] focus:outline-none bg-white"
            rows={8}
      ...
      <div className="p-3 border-t border-gray-200 bg-gray-50">
        <p className="text-xs text-gray-500">
          <strong>Formatação:</strong> **negrito**, *itálico*, ## título. 
          {!showPreview && " Clique em Preview para ver o resultado em tempo real."}
