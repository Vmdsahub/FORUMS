      ...
      <div className="flex-1 relative">
        ...
        <button
          onClick={() => {
            ...
            // Add like animation
            if (!comment.isLiked) {
              const button = document.getElementById(`heart-reply-${comment.id}`);
              if (button) {
          ...
          id={`heart-reply-${comment.id}`}
          className="heart-button absolute bottom-0 right-0 flex items-center gap-1 text-xs transition-all text-gray-600 hover:text-gray-800"
        >
